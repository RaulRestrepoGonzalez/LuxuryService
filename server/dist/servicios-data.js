...
export const SERVICIOS_LUXURY = [
    ...
    { nombre: 'Brillada con Corrección Leve y Protección Acrílica', categoria: 'Servicios Detailing', descripcion: 'Corrección leve y protección acrílica', precio_auto: 380000, precio_camioneta: 445000, duracion_minutos: 180, agendable: true, icono: 'auto_awesome', imagen_url: CORRECT, orden: 20 },
    { nombre: 'Descontaminado de Pintura', categoria: 'Servicios Detailing', descripcion: 'Descontaminado químico y físico', precio_auto: 230000, precio_camioneta: 295000, duracion_minutos: 120, agendable: true, icono: 'auto_awesome', imagen_url: DECONTAM, orden: 21 },
    ...
    { nombre: 'Tratamiento Nano Cerámico', categoria: 'Servicios Detailing', descripcion: 'Protección nanocerámica premium', precio_auto: 1300000, precio_camioneta: 1400000, duracion_minutos: 360, agendable: true, icono: 'auto_awesome', imagen_url: NANO, orden: 31 },
    { nombre: 'Pintura Anticorrosiva', categoria: 'Servicios Anticorrosivos', descripcion: 'Protección y pintura anticorrosiva', precio_auto: 1450000, precio_camioneta: 1550000, duracion_minutos: 480, agendable: true, icono: 'format_paint', imagen_url: RUST, orden: 40 },
