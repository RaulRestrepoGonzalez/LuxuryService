...
export const SERVICIOS_LUXURY = [
    ...
    { nombre: 'Mecánica General', categoria: 'Mecánica', descripcion: 'Mantenimiento preventivo y correctivo: frenos, suspensión, motor, transmisión, A/C, dirección, diagnóstico, alineación, balanceo y más. El valor varía según el tipo de vehículo y la reparación requerida. Cotizar en el local.', precio_auto: 0, precio_camioneta: 0, duracion_minutos: 0, agendable: false, icono: 'build', imagen_url: '', orden: 51, cotizar_local: true },
];
