...
export const SERVICIOS_LUXURY: ServicioSeed[] = [
  ...
  { nombre: 'Encerado Cleaner Wax Básico', categoria: 'Servicios Básicos', descripcion: 'Encerado básico cleaner wax', precio_auto: 40000, precio_camioneta: 50000, duracion_minutos: 40, agendable: true, icono: 'auto_awesome', orden: 4 },
  { nombre: 'Encerado Cleaner Wax con Máquina', categoria: 'Servicios Básicos', descripcion: 'Encerado con máquina', precio_auto: 70000, precio_camioneta: 80000, duracion_minutos: 50, agendable: true, icono: 'auto_awesome', orden: 5 },
