...
@NgModule({
  imports: [CommonModule, AdminRoutingModule, ReactiveFormsModule, DashboardComponent, AppointmentsMgmtComponent, InventoryMgmtComponent, ServicesMgmtComponent, EmailSettingsComponent, ImportDataComponent]
})
