...
export const FALLBACK_SERVICIOS: Servicio[] = [
  ...
  { id: 'fb-04', nombre: 'Encerado Cleaner Wax', descripcion: 'Encerado básico', duracion_minutos: 40, precio_base: 40000, precio_auto: 40000, precio_camioneta: 50000, categoria: 'Servicios Básicos', icono: 'auto_awesome', agendable: true, iva_incluido: true },
